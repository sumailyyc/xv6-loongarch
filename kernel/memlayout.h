...
#define LS7A_INT_AUTO_CTRL0     LS7A_PCH_REG_BASE + 0x0c0
#define LS7A_INT_AUTO_CTRL1     LS7A_PCH_REG_BASE + 0x0e0
#define LS7A_INT_HTMSI_EN_REG		LS7A_PCH_REG_BASE + 0x040
#define LS7A_INT_ROUTE_ENTRY_REG	LS7A_PCH_REG_BASE + 0x100
